...
/* USER CODE BEGIN PV */
const uint8_t simpleCodeInstr[]="*** Simple code for XL320 ***\r\n";
uint8_t XL320_Tx_Buffer[64]={};
unsigned short crc;
/* USER CODE END PV */
...
int main(void)
{
	...
	while (1)
	{
		...
		//				XL320_Tx_Buffer[5] = 0x03;					// Length 1 (Low) (Nb param + Instr + CRC)
		//				XL320_Tx_Buffer[6] = 0x00;					// Length 2 (Hi)
		//				XL320_Tx_Buffer[7] = 0x01;					// Instruction (Ping)
		//				XL320_Tx_Buffer[8] = 0x19;					// CRC 1 (Low)
		//				XL320_Tx_Buffer[9] = 0x4E;					// CRC 2 (High)
		//				HAL_GPIO_WritePin(TX_EN_GPIO_Port, TX_EN_Pin, SET);
		//				HAL_UART_Transmit(&huart1, XL320_Tx_Buffer, 10, 100);
